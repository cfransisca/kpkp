...
while($row=$result->fetch_assoc())
{
	...
	<table>
			...
			<tr><br>
				...
				<td width="10%"><div class='product'><?= $row['jenis']?>&nbsp;<?= $row['ras']?>&nbsp;<?= $row['warna']?></div></td>
				...
				<td width="10%"><button id='save' class='w3-btn w3-khaki w3-card-4' value="<?= $i?>" type="submit" onclick="addModal(this.value,document.getElementById('quantity').value,document.getElementById('hrg').value)">Add To Cart</button></td>
			</tr>
