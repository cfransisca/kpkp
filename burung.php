			 ...
			 <div class="about-grids">
				      	<div class="service-content">
        						...
        						$sql= "select hewan.id_hewan, hewan.warna,hewan.nama,hewan.harga,hewan.foto, jenishewan.jenis, jenishewan.ras
       									...
       									where hewan.id_nota is null && jenishewan.jenis = 'Burung'";
        						$result = mysqli_query($mysql,$sql);
        						...
        						while($row=$result->fetch_assoc())
								{
	                        		...
	                        		<div class="product-item">
            							...
            							<div class="img">
            								<img src="images/burung/<?= $row['foto']?>" width="180" height="230"/>
            							</div>
            								<h4>B<?= $row['id_hewan']?></h4>
										...
										<a href="detail-hewan.php?show=<?= urlencode(base64_encode($row['id_hewan']))?>" class="w3-text-teal">
											...
											<button id="cart" name="add" value="BG<?= $row['id_hewan']?>" style="background:url(http://www.petshopgrosir.com/templates/frontend/psg/images/beli_button.png) no-repeat; border:none; width:131px; height:32px;" onclick="additemCart(this.value)"></button>
           									<br><br><br>
           									</div>
                					</div>
                					</div>
