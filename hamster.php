			 ...
			 <div class="about-grids">
				      	<div class="service-content">
        						...
        						$sql= "select hewan.id_hewan, hewan.warna,hewan.nama,hewan.harga,hewan.foto, jenishewan.jenis, jenishewan.ras
       									...
       									where hewan.id_nota is null && jenishewan.jenis = 'Hamster'";
        						...
        						while($row=$result->fetch_assoc())
								{
	                        		...
	                        		<div class="product-item">
            							...
            							<div class="img">
            								<img src="images/hamster/<?= $row['foto']?>" width="180" height="230"/>
            							</div>
            								<h4>H<?= $row['id_hewan']?></h4>
										...
										<br>
											...
											<button id="cart" name="add" value="H<?= $row['id_hewan']?>" style="background:url(http://www.petshopgrosir.com/templates/frontend/psg/images/beli_button.png) no-repeat; border:none; width:131px; height:32px;" onclick="additemCart(this.value)"></button>
           									<br><br><br>
           									</div>
                					</div>
                					</div>
